...
`;
  ...
  const renderMainScreen = () => (
    ...
    >
      <DialogHeader>
        <DialogTitle>Need help with Studio AI Builder?</DialogTitle>
      </DialogHeader>
      <DialogDescription>
      ...
      <div className="flex flex-col w-full mt-4 space-y-5">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <div className="border rounded-lg p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Includes error logs to troubleshoot non-AI issues with Studio AI Builder (UI
      ...
      >
        ...
        <div className="space-y-2 overflow-y-auto flex-grow mt-4">
          ...
          <ReviewDetailsSection title="System Information" mono={false}>
            <p>Version: {debugBundle.system.dyadVersion}</p>
