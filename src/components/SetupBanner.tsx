...
import type { NodeSystemInfo } from "@platform/shared-types";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
          ...
          >
            ...
            <AccordionContent className="px-4 pt-2 pb-4 bg-white dark:bg-zinc-900 border-t border-inherit">
              ...
              <SetupProviderCard
                ...
                leadingIcon={
                  <img src={logo} alt="Studio AI Builder Logo" className="w-6 h-6 mr-0.5" />
                }
                title="Start with Studio AI Builder Pro free trial"
                subtitle="Unlock the full power of Studio AI Builder"
                chip={<>Recommended</>}
              />
    ...
    case "finished-checking":
      return (
        <div className="mt-3 text-sm text-red-600 dark:text-red-400">
          Node.js not detected. Closing and re-opening Studio AI Builder usually fixes this.
        </div>
      );
    default:
